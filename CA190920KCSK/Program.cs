...
namespace CA190920KCSK
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            kecskek.Add(new Kecske("Béla", false, new DateTime(1900, 01, 16)));
            kecskek.Add(new Kecske("Asdasd", false, new DateTime(1900, 01, 16)));
            kecskek.Add(new Kecske("Ferenc", false, new DateTime(1900, 01, 16)));
            kecskek.Add(new Kecske("UriGeller",true, new DateTime(1960, 11, 16)));
